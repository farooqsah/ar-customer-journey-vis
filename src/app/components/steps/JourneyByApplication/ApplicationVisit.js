  ...
  return (
    ...
    >
        ...
        <Stepper>
          {props.steps.map((step, index) => (
            <Step active={true} key={index}>
              <StepLabel>
                <Button href="/aggregate-visualizer" variant="contained">
                  {step} &gt;
                </Button>
              </StepLabel>
            </Step>
      ...
      >
        ...
        />
        <FormControlLabel
          value="heatmapData_DRInactive"
          control={<Radio />}
          label="DRInactive"
        />
        <FormControlLabel
          value="heatmapData_PLEnrolled"
          control={<Radio />}
          label="PLEnrolled"
        />
        <FormControlLabel
          value="heatmapData_DREnrolledStraight"
          control={<Radio />}
          label="DREnrolledStraight"
        />
      </RadioGroup>
      <CustomizedDialogs
        imageSrc="/images/APLhome.png"
        label="APL Home"
        title="APL Home"
      />
      <CustomizedDialogs
        imageSrc="/images/debtReleaf.png"
